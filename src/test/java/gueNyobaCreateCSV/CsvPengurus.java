...
public class CsvPengurus {
    private String pthResultDataDummyFile = Const.resultDataDummyFile;
    ArrayList<String[]> arrayData = new ArrayList<>();
    String jW;

    GeneratorPengurus gp = new GeneratorPengurus();

    public void dataDummy(String case1, String case2, String input_jumlah_data) throws IOException {

        String nama_debitur, name_company, code_company, kode_produk, tanggal, jumlahData, code_company2, kode_produk2;
        ...
        code_company2                     ="L000005";
        kode_produk2                      ="24BL001";
        tanggal                           = fdate;
...
//        jumlahData                        = input_jumlah_data;
        ...
        try {
            ...
            for (int idxApp = 1; idxApp <= Integer.parseInt(jumlahData); idxApp++) {
                if (idxApp == 2) {
                    dataApp.add(new String[]{
                            code_company2 + generateRandomDataApp.nomorAplikasi(17),
...
//                            "2", generateRandomDataRea.cd_sektorEkonomi(environment), "00000010000000000", "1", "S125012529L", "000002300000000", "18", "Jakarta Selatan"});
            ...
            for (String[] pengurusData : dataRea) {
                if (pengurusData[0] != "Nomor_Aplikasi") {
                    try {
                        if (pengurusData[0].contains("L000005")) {
                            File file = new File(pthResultDataDummyFile + "PENGURUS_" + code_company2 + "_" + kode_produk2 + "_" + pengurusData[0] + "_" + tanggal + Const.extCSV);
                            // create FileWriter object with file as parameter
                                ...
                                switch (i) {
                                    ...
                                    case 1:
                                        String[] dataPengurus = {pengurusData[0], gp.nomorUrutPengurus("01"), "0" + gp.jumlahPengurus(),
                                                ...
                                                gp.modalDitempatkan(12), gp.npwp(), "Orang" + gp.namaPengurus(59), "Jalan" + gp.alamatPengurus(34), "Kelurahan" + gp.alamatKelurahan(30),
                                    ...
                                    case 2:
                                        dataPengurus = new String[]{pengurusData[0], gp.nomorUrutPengurus("02"), "0" + gp.jumlahPengurus(),
                                                ...
                                                gp.modalDitempatkan(13), gp.npwp(), "Orang" + gp.namaPengurus(60), "Jalan" + gp.alamatPengurus(35), "Kelurahan" + gp.alamatKelurahan(31),
                            ...
                            while (i <= 4) {
                                switch (i) {
                                    ...
                                    case 1:
                                        String[] dataPengurus = {pengurusData[0], gp.nomorUrutPengurus("01"), "0" + gp.jumlahPengurus(),
                                                gp.sandiJabatanBI(2), "0" + gp.pangsaKepemilikan("1913"), gp.bentukPengurus("2"), gp.modalDasar(12),gp.modalDisetor(12),
                                                gp.modalDitempatkan(12), gp.npwp(), gp.namaPengurus(59), gp.alamatPengurus(39), gp.alamatKelurahan(39),
                                                 gp.alamatKecamatan(39), gp.alamatDati(), gp.noKtp(), gp.noAkte(29), gp.tglLahir(), gp.tglAkte(),
                                                gp.alamatDatiLhr(), gp.jnsKelamin("B")};
                                        writer.writeNext(dataPengurus);
                                        break;
                                    ...
                                    case 2:
                                        dataPengurus = new String[]{pengurusData[0], gp.nomorUrutPengurus("02"), "0" + gp.jumlahPengurus(),
                                                gp.sandiJabatanBI(1), "0" + gp.pangsaKepemilikan("5049"), gp.bentukPengurus("1"), gp.modalDasar(13), gp.modalDisetor(13),
                                                 gp.modalDitempatkan(13), gp.npwp(), gp.namaPengurus(60),  gp.alamatPengurus(40),  gp.alamatKelurahan(40),
                                                 gp.alamatKecamatan(40), gp.alamatDati(), gp.noKtp(), gp.noAkte(30), gp.tglLahir(), gp.tglAkte(),
                                                gp.alamatDatiLhr(), gp.jnsKelamin("M")};
                                        writer.writeNext(dataPengurus);
                                        break;
    ...
    public static void main(String[] args) throws IOException {
        ...
        cp.dataDummy(Const.appFile, Const.reaFile, "2");
    }
}
