...
@CucumberOptions(
        ...
        tags = "@pengurusBU",
        features = {"src/test/resources/Features/validatePengurusBU.feature"},
        glue = {"definitions"}
)
public class pengurusRunner extends AbstractTestNGCucumberTests{
...
//                }
        ...
        public void runScenarioValidateFile(PickleWrapper pickleWrapper, FeatureWrapper featureWrapper) {
